...
employee_source_file =  os.getcwd() + r"\\Emp1.html"
employee_destin_file = os.getcwd() + r"\\Emp2.html"
...
if __name__ == "__main__":
    ...
    driver_source = webdriver.Chrome("C:\\Driver\\chromedriver.exe")
    ...
    driver_destin = webdriver.Chrome("C:\\Driver\\chromedriver.exe")
